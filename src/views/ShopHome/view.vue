      ...
      <div class="popup-box flex">
        ...
        <ul>
          <li
            ...
            :key="index"
            :class="{pass: ['未签', '已签'].includes(transSignIn(item, index))}"
          >
    ...
    <div class="recommend">
      ...
      <ul class="list">
        <li class="flex" v-for="(item,index) in hotList" :key="index">
          <div
            class="recomment_img"
            :style="`background-image: url(${item.commodityImage}); background-size: cover; background-position: 50% 50%`"
          ></div>
    ...
    <div class="recommend">
      ...
      <ul class="list">
        <li class="flex" v-for="(items,index) in commodityList" :key="index">
          <div
            class="recomment_img"
            :style="`background-image: url(${items.commodityImage}); background-size: cover; background-position: 50% 50%`"
          ></div>
